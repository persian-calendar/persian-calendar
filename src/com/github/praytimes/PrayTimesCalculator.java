...
public class PrayTimesCalculator {
	MinuteOrAngleDouble _imsak = min(10);
	MinuteOrAngleDouble _dhuhr = min(0);
	CalculationMethod.AsrJuristics _asr = CalculationMethod.AsrJuristics.Standard;
	CalculationMethod.HighLatMethods _highLats = CalculationMethod.HighLatMethods.NightMiddle;
	boolean _dst;
	double _timeZone, _jDate;
	Coordinate _coordinate;
	CalculationMethod _method;

	// default times
	static Map<PrayTime, Double> _defaultTimes;
	static {
	...
	public Map<PrayTime, Clock> calculate(Date date, Coordinate coordinate, Double timeZone) {
