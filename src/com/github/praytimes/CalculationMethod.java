...
import static com.github.praytimes.StaticUtils.*; // for min() and deg()
...
public enum CalculationMethod {
	...
	Tehran("Institute of Geophysics, University of Tehran", deg(17.7), deg(14),
			deg(4.5), MidnightType.Jafari),
