...
//            listOf(2041, 12, 24, 1464, 1, 1)
    ...
    private val moonInScorpioDaysOf1404 = mapOf(
        Jdn(PersianDate(1403, 12, 27)) to MoonInScorpioState.Start::class.java,
        Jdn(PersianDate(1403, 12, 28)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1403, 12, 29)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1403, 12, 30)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1403, 12, 31)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 1, 1)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 1, 2)) to MoonInScorpioState.End::class.java,
        Jdn(PersianDate(1404, 1, 24)) to MoonInScorpioState.Start::class.java,
        Jdn(PersianDate(1404, 1, 25)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 1, 26)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 1, 27)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 1, 28)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 1, 29)) to MoonInScorpioState.End::class.java,
        Jdn(PersianDate(1404, 2, 20)) to MoonInScorpioState.Start::class.java,
        Jdn(PersianDate(1404, 2, 21)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 2, 22)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 2, 23)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 2, 24)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 2, 25)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 2, 26)) to MoonInScorpioState.End::class.java,
        Jdn(PersianDate(1404, 3, 17)) to MoonInScorpioState.Start::class.java,
        Jdn(PersianDate(1404, 3, 18)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 3, 19)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 3, 20)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 3, 21)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 3, 22)) to MoonInScorpioState.End::class.java,
        Jdn(PersianDate(1404, 4, 13)) to MoonInScorpioState.Start::class.java,
        Jdn(PersianDate(1404, 4, 14)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 4, 15)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 4, 16)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 4, 17)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 4, 18)) to MoonInScorpioState.End::class.java,
        Jdn(PersianDate(1404, 5, 9)) to MoonInScorpioState.Start::class.java,
        Jdn(PersianDate(1404, 5, 10)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 5, 11)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 5, 12)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 5, 13)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 5, 14)) to MoonInScorpioState.End::class.java,
        Jdn(PersianDate(1404, 6, 6)) to MoonInScorpioState.Start::class.java,
        Jdn(PersianDate(1404, 6, 7)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 6, 8)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 6, 9)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 6, 10)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 6, 11)) to MoonInScorpioState.End::class.java,
        Jdn(PersianDate(1404, 7, 2)) to MoonInScorpioState.Start::class.java,
        Jdn(PersianDate(1404, 7, 3)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 7, 4)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 7, 5)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 7, 6)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 7, 7)) to MoonInScorpioState.End::class.java,
        Jdn(PersianDate(1404, 7, 29)) to MoonInScorpioState.Start::class.java,
        Jdn(PersianDate(1404, 7, 30)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 8, 1)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 8, 2)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 8, 3)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 8, 4)) to MoonInScorpioState.End::class.java,
        Jdn(PersianDate(1404, 8, 27)) to MoonInScorpioState.Start::class.java,
        Jdn(PersianDate(1404, 8, 28)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 8, 29)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 8, 30)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 9, 1)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 9, 2)) to MoonInScorpioState.End::class.java,
        Jdn(PersianDate(1404, 9, 24)) to MoonInScorpioState.Start::class.java,
        Jdn(PersianDate(1404, 9, 25)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 9, 26)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 9, 27)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 9, 28)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 9, 29)) to MoonInScorpioState.End::class.java,
        Jdn(PersianDate(1404, 10, 21)) to MoonInScorpioState.Start::class.java,
        Jdn(PersianDate(1404, 10, 22)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 10, 23)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 10, 24)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 10, 25)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 10, 26)) to MoonInScorpioState.End::class.java,
        Jdn(PersianDate(1404, 11, 18)) to MoonInScorpioState.Start::class.java,
        Jdn(PersianDate(1404, 11, 19)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 11, 20)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 11, 21)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 11, 22)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 11, 23)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 11, 24)) to MoonInScorpioState.End::class.java,
        Jdn(PersianDate(1404, 12, 16)) to MoonInScorpioState.Start::class.java,
        Jdn(PersianDate(1404, 12, 17)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 12, 18)) to MoonInScorpioState.Borji::class.java,
        Jdn(PersianDate(1404, 12, 19)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 12, 20)) to MoonInScorpioState.Falaki::class.java,
        Jdn(PersianDate(1404, 12, 21)) to MoonInScorpioState.End::class.java,
    )
    ...
    fun `moon in scorpio calculation correctness`() {
        run {
            ...
            assertEquals(
                ...
                moonInScorpioState(jdn, setIranTime = true)?.javaClass,
                "${jdn.toPersianDate()}"
            )
        }
    }
