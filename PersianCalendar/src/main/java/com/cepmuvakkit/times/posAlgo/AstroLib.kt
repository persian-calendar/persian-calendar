...
object AstroLib {
    ...
    // ------------------------------------------------------------------------------
    fun Pegasus(
        moonPhase: MoonPhases, LowerBound: Double,
        UpperBound: Double, ΔT: Double, Accuracy: Double, Success: BooleanArray,
        phase: Int
    ): Double {
        var x1 = LowerBound
        var x2 = UpperBound
        var f1 = moonPhase.searchPhaseEvent(x1, ΔT, phase)
        var f2 = moonPhase.searchPhaseEvent(x2, ΔT, phase)
        var x3: Double
        var f3: Double
        var Root: Double
        val MaxIterat = 30
