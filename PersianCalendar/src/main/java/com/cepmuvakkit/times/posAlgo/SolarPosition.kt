...
object SolarPosition {
    ...
    private val LTERMS = listOf(
        ...
        listOf(doubleArrayOf(1.0, 3.14, 0.0))
    )
    private val BTERMS = listOf(
        ...
        ), listOf(doubleArrayOf(9.0, 3.9, 5507.55), doubleArrayOf(6.0, 1.73, 5223.69))
    )
    ...
    private val RTERMS = listOf(
        ...
        listOf(doubleArrayOf(145.0, 4.273, 6283.076), doubleArrayOf(7.0, 3.92, 12566.15)),
        listOf(doubleArrayOf(4.0, 2.56, 6283.08))
    )
    ...
    fun sunRiseAndSet(
        ...
        return mRts[sun] + (hRts[sun] - h0Prime) / 360.0 * cos(Math.toRadians(δPrime[sun])) * cos(Math.toRadians(latitude)) * sin(
            Math.toRadians(
                hPrime[sun]
            )
        )
