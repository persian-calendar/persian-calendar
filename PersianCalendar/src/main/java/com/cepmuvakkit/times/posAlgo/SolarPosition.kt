...
object SolarPosition {
    ...
    private val LTERMS = listOf(
        listOf(
            listOf(175347046.0, 0.0, 0.0),
            listOf(3341656.0, 4.6692568, 6283.07585),
            listOf(34894.0, 4.6261, 12566.1517),
            listOf(3497.0, 2.7441, 5753.3849),
            listOf(3418.0, 2.8289, 3.5231),
            listOf(3136.0, 3.6277, 77713.7715),
            listOf(2676.0, 4.4181, 7860.4194),
            listOf(2343.0, 6.1352, 3930.2097),
            listOf(1324.0, 0.7425, 11506.7698),
            listOf(1273.0, 2.0371, 529.691),
            listOf(1199.0, 1.1096, 1577.3435),
            listOf(990.0, 5.233, 5884.927),
            listOf(902.0, 2.045, 26.298),
            listOf(857.0, 3.508, 398.149),
            listOf(780.0, 1.179, 5223.694),
            listOf(753.0, 2.533, 5507.553),
            listOf(505.0, 4.583, 18849.228),
            listOf(492.0, 4.205, 775.523),
            listOf(357.0, 2.92, 0.067),
            listOf(317.0, 5.849, 11790.629),
            listOf(284.0, 1.899, 796.298),
            listOf(271.0, 0.315, 10977.079),
            listOf(243.0, 0.345, 5486.778),
            listOf(206.0, 4.806, 2544.314),
            listOf(205.0, 1.869, 5573.143),
            listOf(202.0, 2.458, 6069.777),
            listOf(156.0, 0.833, 213.299),
            listOf(132.0, 3.411, 2942.463),
            listOf(126.0, 1.083, 20.775),
            listOf(115.0, 0.645, 0.98),
            listOf(103.0, 0.636, 4694.003),
            listOf(102.0, 0.976, 15720.839),
            listOf(102.0, 4.267, 7.114),
            listOf(99.0, 6.21, 2146.17),
            listOf(98.0, 0.68, 155.42),
            listOf(86.0, 5.98, 161000.69),
            listOf(85.0, 1.3, 6275.96),
            listOf(85.0, 3.67, 71430.7),
            listOf(80.0, 1.81, 17260.15),
            listOf(79.0, 3.04, 12036.46),
            listOf(75.0, 1.76, 5088.63),
            listOf(74.0, 3.5, 3154.69),
            listOf(74.0, 4.68, 801.82),
            listOf(70.0, 0.83, 9437.76),
            listOf(62.0, 3.98, 8827.39),
            listOf(61.0, 1.82, 7084.9),
            listOf(57.0, 2.78, 6286.6),
            listOf(56.0, 4.39, 14143.5),
            listOf(56.0, 3.47, 6279.55),
            listOf(52.0, 0.19, 12139.55),
            listOf(52.0, 1.33, 1748.02),
            listOf(51.0, 0.28, 5856.48),
            listOf(49.0, 0.49, 1194.45),
            listOf(41.0, 5.37, 8429.24),
            listOf(41.0, 2.4, 19651.05),
            listOf(39.0, 6.17, 10447.39),
            listOf(37.0, 6.04, 10213.29),
            listOf(37.0, 2.57, 1059.38),
            listOf(36.0, 1.71, 2352.87),
            listOf(36.0, 1.78, 6812.77),
            listOf(33.0, 0.59, 17789.85),
            listOf(30.0, 0.44, 83996.85),
            listOf(30.0, 2.74, 1349.87),
            listOf(25.0, 3.16, 4690.48)
        ),
        listOf(
            listOf(628331966747.0, 0.0, 0.0),
            listOf(206059.0, 2.678235, 6283.07585),
            listOf(4303.0, 2.6351, 12566.1517),
            listOf(425.0, 1.59, 3.523),
            listOf(119.0, 5.796, 26.298),
            listOf(109.0, 2.966, 1577.344),
            listOf(93.0, 2.59, 18849.23),
            listOf(72.0, 1.14, 529.69),
            listOf(68.0, 1.87, 398.15),
            listOf(67.0, 4.41, 5507.55),
            listOf(59.0, 2.89, 5223.69),
            listOf(56.0, 2.17, 155.42),
            listOf(45.0, 0.4, 796.3),
            listOf(36.0, 0.47, 775.52),
            listOf(29.0, 2.65, 7.11),
            listOf(21.0, 5.34, 0.98),
            listOf(19.0, 1.85, 5486.78),
            listOf(19.0, 4.97, 213.3),
            listOf(17.0, 2.99, 6275.96),
            listOf(16.0, 0.03, 2544.31),
            listOf(16.0, 1.43, 2146.17),
            listOf(15.0, 1.21, 10977.08),
            listOf(12.0, 2.83, 1748.02),
            listOf(12.0, 3.26, 5088.63),
            listOf(12.0, 5.27, 1194.45),
            listOf(12.0, 2.08, 4694.0),
            listOf(11.0, 0.77, 553.57),
            listOf(10.0, 1.3, 6286.6),
            listOf(10.0, 4.24, 1349.87),
            listOf(9.0, 2.7, 242.73),
            listOf(9.0, 5.64, 951.72),
            listOf(8.0, 5.3, 2352.87),
            listOf(6.0, 2.65, 9437.76),
            listOf(6.0, 4.67, 4690.48)
        ),
        listOf(
            listOf(52919.0, 0.0, 0.0),
            listOf(8720.0, 1.0721, 6283.0758),
            listOf(309.0, 0.867, 12566.152),
            listOf(27.0, 0.05, 3.52),
            listOf(16.0, 5.19, 26.3),
            listOf(16.0, 3.68, 155.42),
            listOf(10.0, 0.76, 18849.23),
            listOf(9.0, 2.06, 77713.77),
            listOf(7.0, 0.83, 775.52),
            listOf(5.0, 4.66, 1577.34),
            listOf(4.0, 1.03, 7.11),
            listOf(4.0, 3.44, 5573.14),
            listOf(3.0, 5.14, 796.3),
            listOf(3.0, 6.05, 5507.55),
            listOf(3.0, 1.19, 242.73),
            listOf(3.0, 6.12, 529.69),
            listOf(3.0, 0.31, 398.15),
            listOf(3.0, 2.28, 553.57),
            listOf(2.0, 4.38, 5223.69),
            listOf(2.0, 3.75, 0.98)
        ),
        listOf(
            listOf(289.0, 5.844, 6283.076),
            listOf(35.0, 0.0, 0.0),
            listOf(17.0, 5.49, 12566.15),
            listOf(3.0, 5.2, 155.42),
            listOf(1.0, 4.72, 3.52),
            listOf(1.0, 5.3, 18849.23),
            listOf(1.0, 5.97, 242.73)
        ),
        listOf(
            listOf(114.0, 3.142, 0.0),
            listOf(8.0, 4.13, 6283.08),
            listOf(1.0, 3.84, 12566.15)
        ),
        listOf(listOf(1.0, 3.14, 0.0))
    )
    private val BTERMS = listOf(
        listOf(
            listOf(280.0, 3.199, 84334.662),
            listOf(102.0, 5.422, 5507.553),
            listOf(80.0, 3.88, 5223.69),
            listOf(44.0, 3.7, 2352.87),
            listOf(32.0, 4.0, 1577.34)
        ),
        listOf(
            listOf(9.0, 3.9, 5507.55),
            listOf(6.0, 1.73, 5223.69)
        )
    )
    ...
    private val RTERMS = listOf(
        listOf(
            listOf(100013989.0, 0.0, 0.0),
            listOf(1670700.0, 3.0984635, 6283.07585),
            listOf(13956.0, 3.05525, 12566.1517),
            listOf(3084.0, 5.1985, 77713.7715),
            listOf(1628.0, 1.1739, 5753.3849),
            listOf(1576.0, 2.8469, 7860.4194),
            listOf(925.0, 5.453, 11506.77),
            listOf(542.0, 4.564, 3930.21),
            listOf(472.0, 3.661, 5884.927),
            listOf(346.0, 0.964, 5507.553),
            listOf(329.0, 5.9, 5223.694),
            listOf(307.0, 0.299, 5573.143),
            listOf(243.0, 4.273, 11790.629),
            listOf(212.0, 5.847, 1577.344),
            listOf(186.0, 5.022, 10977.079),
            listOf(175.0, 3.012, 18849.228),
            listOf(110.0, 5.055, 5486.778),
            listOf(98.0, 0.89, 6069.78),
            listOf(86.0, 5.69, 15720.84),
            listOf(86.0, 1.27, 161000.69),
            listOf(65.0, 0.27, 17260.15),
            listOf(63.0, 0.92, 529.69),
            listOf(57.0, 2.01, 83996.85),
            listOf(56.0, 5.24, 71430.7),
            listOf(49.0, 3.25, 2544.31),
            listOf(47.0, 2.58, 775.52),
            listOf(45.0, 5.54, 9437.76),
            listOf(43.0, 6.01, 6275.96),
            listOf(39.0, 5.36, 4694.0),
            listOf(38.0, 2.39, 8827.39),
            listOf(37.0, 0.83, 19651.05),
            listOf(37.0, 4.9, 12139.55),
            listOf(36.0, 1.67, 12036.46),
            listOf(35.0, 1.84, 2942.46),
            listOf(33.0, 0.24, 7084.9),
            listOf(32.0, 0.18, 5088.63),
            listOf(32.0, 1.78, 398.15),
            listOf(28.0, 1.21, 6286.6),
            listOf(28.0, 1.9, 6279.55),
            listOf(26.0, 4.59, 10447.39)
        ),
        listOf(
            listOf(103019.0, 1.10749, 6283.07585),
            listOf(1721.0, 1.0644, 12566.1517),
            listOf(702.0, 3.142, 0.0),
            listOf(32.0, 1.02, 18849.23),
            listOf(31.0, 2.84, 5507.55),
            listOf(25.0, 1.32, 5223.69),
            listOf(18.0, 1.42, 1577.34),
            listOf(10.0, 5.91, 10977.08),
            listOf(9.0, 1.42, 6275.96),
            listOf(9.0, 0.27, 5486.78)
        ),
        listOf(
            listOf(4359.0, 5.7846, 6283.0758),
            listOf(124.0, 5.579, 12566.152),
            listOf(12.0, 3.14, 0.0),
            listOf(9.0, 3.63, 77713.77),
            listOf(6.0, 1.87, 5573.14),
            listOf(3.0, 5.47, 18849.23)
        ),
    ...
    private val PETERMS = listOf(
        listOf(-171996.0, -174.2, 92025.0, 8.9),
        listOf(-13187.0, -1.6, 5736.0, -3.1),
        listOf(-2274.0, -0.2, 977.0, -0.5),
        listOf(2062.0, 0.2, -895.0, 0.5),
        listOf(1426.0, -3.4, 54.0, -0.1),
        listOf(712.0, 0.1, -7.0, 0.0),
        listOf(-517.0, 1.2, 224.0, -0.6),
        listOf(-386.0, -0.4, 200.0, 0.0),
        listOf(-301.0, 0.0, 129.0, -0.1),
        listOf(217.0, -0.5, -95.0, 0.3),
        listOf(-158.0, 0.0, 0.0, 0.0),
        listOf(129.0, 0.1, -70.0, 0.0),
        listOf(123.0, 0.0, -53.0, 0.0),
        listOf(63.0, 0.0, 0.0, 0.0),
        listOf(63.0, 0.1, -33.0, 0.0),
        listOf(-59.0, 0.0, 26.0, 0.0),
        listOf(-58.0, -0.1, 32.0, 0.0),
        listOf(-51.0, 0.0, 27.0, 0.0),
        listOf(48.0, 0.0, 0.0, 0.0),
        listOf(46.0, 0.0, -24.0, 0.0),
        listOf(-38.0, 0.0, 16.0, 0.0),
        listOf(-31.0, 0.0, 13.0, 0.0),
        listOf(29.0, 0.0, 0.0, 0.0),
        listOf(29.0, 0.0, -12.0, 0.0),
        listOf(26.0, 0.0, 0.0, 0.0),
        listOf(-22.0, 0.0, 0.0, 0.0),
        listOf(21.0, 0.0, -10.0, 0.0),
        listOf(17.0, -0.1, 0.0, 0.0),
        listOf(16.0, 0.0, -8.0, 0.0),
        listOf(-16.0, 0.1, 7.0, 0.0),
        listOf(-15.0, 0.0, 9.0, 0.0),
        listOf(-13.0, 0.0, 7.0, 0.0),
        listOf(-12.0, 0.0, 6.0, 0.0),
        listOf(11.0, 0.0, 0.0, 0.0),
        listOf(-10.0, 0.0, 5.0, 0.0),
        listOf(-8.0, 0.0, 3.0, 0.0),
        listOf(7.0, 0.0, -3.0, 0.0),
        listOf(-7.0, 0.0, 0.0, 0.0),
        listOf(-7.0, 0.0, 3.0, 0.0),
        listOf(-7.0, 0.0, 3.0, 0.0),
        listOf(6.0, 0.0, 0.0, 0.0),
        listOf(6.0, 0.0, -3.0, 0.0),
        listOf(6.0, 0.0, -3.0, 0.0),
        listOf(-6.0, 0.0, 3.0, 0.0),
        listOf(-6.0, 0.0, 3.0, 0.0),
        listOf(5.0, 0.0, 0.0, 0.0),
        listOf(-5.0, 0.0, 3.0, 0.0),
        listOf(-5.0, 0.0, 3.0, 0.0),
        listOf(-5.0, 0.0, 3.0, 0.0),
        listOf(4.0, 0.0, 0.0, 0.0),
        listOf(4.0, 0.0, 0.0, 0.0),
        listOf(4.0, 0.0, 0.0, 0.0),
        listOf(-4.0, 0.0, 0.0, 0.0),
        listOf(-4.0, 0.0, 0.0, 0.0),
    ...
    fun greenwichSiderealTime(ν0: Double, Δψ: Double, ε: Double): Double {
        return ν0 + Δψ * cos(Math.toRadians(ε))
    }
    ...
    fun sunRightAscensionParallaxAndTopocentricDec(
        ...
        δαRad = atan2(
            ...
            cos(δRad) - x * sin(xiRad) * cos(hRad)
        )
        δPrime = Math.toDegrees(
            atan2(
                (sin(δRad) - y * sin(xiRad)) * cos(δαRad),
                cos(δRad) - x * sin(xiRad) * cos(hRad)
            )
        )
    ...
    fun rtsSunAltitude(latitude: Double, δPrime: Double, hPrime: Double): Double {
        ...
        return Math.toDegrees(
            asin(
                sin(latitudeRad) * sin(δPrimeRad)
                        + cos(latitudeRad) * cos(δPrimeRad) * cos(
                    Math.toRadians(
                        hPrime
                    )
                )
    ...
    fun sunRiseAndSet(
        ...
        return mRts[sun] + (hRts[sun] - h0Prime) / 360.0 * cos(Math.toRadians(δPrime[sun])) * cos(
    ...
    fun calculateEquationOfTime(M: Double, α: Double, Δψ: Double, ε: Double): Double {
        return limitMinutes(4.0 * (M - 0.0057183 - α + Δψ * cos(Math.toRadians(ε))))
    }
}
