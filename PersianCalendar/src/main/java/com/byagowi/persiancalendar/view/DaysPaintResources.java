...
public class DaysPaintResources {
    ...
    public DaysPaintResources(Context context) {
        ...
        linePaint.setStrokeWidth(resources
                .getDimensionPixelSize(R.dimen.day_item_event_bar_thickness));

        todayPaint.setStyle(Paint.Style.STROKE);
        todayPaint.setStrokeWidth(resources
                .getDimensionPixelSize(R.dimen.day_item_today_indicator_thickness));
        ...
        halfEventBarWidth = resources
                .getDimensionPixelSize(R.dimen.day_item_event_bar_width) / 2;
        eventYOffset = resources
                .getDimensionPixelSize(R.dimen.day_item_event_y_offset);
        appointmentYOffset = resources
                .getDimensionPixelSize(R.dimen.day_item_appointment_y_offset);
        weekNumberTextSize = resources
                .getDimensionPixelSize(R.dimen.day_item_week_number_text_size);
        weekDaysInitialTextSize = resources
                .getDimensionPixelSize(R.dimen.day_item_week_days_initial_text_size);
        arabicDigitsTextSize = resources
                .getDimensionPixelSize(R.dimen.day_item_arabic_digits_text_size);
        persianDigitsTextSize = resources
                .getDimensionPixelSize(R.dimen.day_item_persian_digits_text_size);

        Typeface face = Typeface.createFromAsset(context.getAssets(), Constants.FONT_PATH);
