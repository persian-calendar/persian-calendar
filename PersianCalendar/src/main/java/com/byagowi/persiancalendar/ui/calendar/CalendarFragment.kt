...
class CalendarFragment : DaggerFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater,
        ...
        mCalendarsView.setOnCalendarsViewExpandListener(object : CalendarsView.OnCalendarsViewExpandListener {
            override fun onCalendarsViewExpand() {
                mMainBinding.tabsViewPager.measureCurrentView(mCalendarsView)
            }
        })
        mCalendarsView.setOnShowHideTodayButton(object : CalendarsView.OnShowHideTodayButton {
        ...
        mMainBinding.tabsViewPager.adapter = TabsViewPager.TabsAdapter(childFragmentManager,
    ...
    private fun showEvent(jdn: Long, isToday: Boolean) {
        mEventsBinding.shiftWorkTitle.text = Utils.getShiftWorkTitle(jdn, false)
        ...
        mEventsBinding.todayButtonSpace.visibility = if (isToday) View.GONE else View.VISIBLE
    ...
    private fun setOwghat(jdn: Long, isToday: Boolean) {
        ...
        if (isToday) {
            ...
            if (mMainBinding.tabsViewPager.currentItem == Constants.OWGHAT_TAB) {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        mSearchView?.setOnSearchClickListener {
            ...
            mSearchView?.findViewById<View>(androidx.appcompat.R.id.search_plate)
