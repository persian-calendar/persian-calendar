...
fun EmailDialog(onDismissRequest: () -> Unit) {
    ...
    if (firstPass) return CompositionLocalProvider(
        ...
        AppDialog(
            ...
            Text(
                """بسیاری از بازخوردهای دریافت شده در این برنامه دربارهٔ مناسبت‌هاست حال آنکه به دلیل محدودیت منابع و حجم برنامه نمایش تعطیلی‌های رسمی همواره اولویت برنامه بوده است.
