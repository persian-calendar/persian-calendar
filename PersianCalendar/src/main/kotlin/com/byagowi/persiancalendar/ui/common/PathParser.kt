...
object PathParser {
    ...
    fun interpolatePathDataNodes(
        target: Array<PathDataNode>?, from: Array<PathDataNode>?,
        to: Array<PathDataNode>?, fraction: Float
    ): Boolean {
        require(!(target == null || from == null || to == null)) {
    ...
    class PathDataNode {
        ...
        internal constructor(n: PathDataNode) {
            mType = n.mType
            mParams = copyOfRange(n.mParams, 0, n.mParams.size)
        }
        ...
        fun interpolatePathDataNode(
            nodeFrom: PathDataNode, nodeTo: PathDataNode,
            fraction: Float
        ) {
