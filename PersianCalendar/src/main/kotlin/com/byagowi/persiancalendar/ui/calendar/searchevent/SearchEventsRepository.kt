...
class SearchEventsRepository @WorkerThread constructor(context: Context):
    ISearchEventsRepository {

    private val jdn = Jdn.today()
    // Hopefully we can get rid of these global variables someday
    override val events: List<CalendarEvent<*>> = listOf(
    ...
    override fun query(constraint: CharSequence): List<CalendarEvent<*>> {
