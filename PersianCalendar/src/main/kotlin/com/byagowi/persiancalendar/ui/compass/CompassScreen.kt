...
class CompassScreen : Fragment(R.layout.fragment_compass) {
    ...
    override fun onResume() {
        ...
        if (orientationSensor != null) {
            ...
            if (coordinates.value == null) showLongSnackbar(R.string.set_location, Snackbar.LENGTH_SHORT)
    ...
    private fun checkIfA11yAnnounceIsNeeded(angle: Float) {
        ...
        binding.compassView.qiblaHeading?.heading?.also {
            qiblaAnnouncer.check(binding.root.context, isNearToDegree(it, angle))
        }
    }
