...
dependencies {
    ...
    minApi21Implementation("com.google.android.material:compose-theme-adapter:1.1.9")
    ...
    minApi21Implementation("androidx.compose.material3:material3:1.0.0-alpha11")
